...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new RadeException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, TaskInfoEntity scheduleJob) {
        try {
            ...
            throw new RadeException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, TaskInfoEntity scheduleJob) {
        try {
            ...
            throw new RadeException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, TaskInfoEntity scheduleJob) {
        try {
            ...
            throw new RadeException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new RadeException("暂停定时任务失败", e);
        }
    }
    ...
    public static void resumeJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new RadeException("恢复定时任务失败", e);
        }
    }

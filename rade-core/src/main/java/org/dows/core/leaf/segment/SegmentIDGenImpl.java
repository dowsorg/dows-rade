package org.dows.core.leaf.segment;
...
import org.dows.core.leaf.common.Result;
import org.dows.core.leaf.common.Status;
import org.dows.core.leaf.segment.entity.LeafAllocEntity;
import org.dows.core.leaf.segment.mapper.LeafAllocMapper;
import org.dows.core.leaf.segment.model.Segment;
import org.dows.core.leaf.segment.model.SegmentBuffer;
...
import static org.dows.core.leaf.segment.entity.table.LeafAllocEntityTableDef.LEAF_ALLOC_ENTITY;
...
public class SegmentIDGenImpl implements IDGenService, DisposableBean {
    ...
    public long next(String key) {
        ...
        RadePreconditions.check(result.getId() < 0, "获取失败，code值: {}", result.getId());
        return result.getId();
    }
    ...
    private Result get(final String key) {
        ...
        RadePreconditions.check(!initOK, "IDCache未初始化成功");

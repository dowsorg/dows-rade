...
public class CodeGenerator {
    ...
    public void init() {
        ...
        baseSrcPath = System.getProperty("user.dir") + "/src/main/java/org/dows/modules/";
        baseResPath = System.getProperty("user.dir") + "/src/main/resources/";
    }

    public TemplateEngine templateEngine() {
        return TemplateUtil.createEngine(
                new TemplateConfig("rade/code", TemplateConfig.ResourceMode.CLASSPATH));
    }

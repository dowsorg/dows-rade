...
import org.dows.core.annotation.RadePlugin;
...
public class AnnotationUtils {
     ...
     * 插件
     */
    public static boolean hasPluginAnnotation(Class<?> clazz) {
        if (clazz == null) {
            return false;
        }
        // 是否是接口
        ...
        try {
            ...
            if (clazz.getAnnotation(
                    (Class<? extends Annotation>) contextClassLoader.loadClass(RadePlugin.class.getName())) != null) {
                return true;
            }
        } catch (Exception e) {

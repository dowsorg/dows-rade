package org.dows.modules.rbac.controller;
...
public class AdminBaseSysRoleController extends BaseController<BaseSysRoleService, BaseSysRoleEntity> {
    ...
    protected void init(HttpServletRequest request, JSONObject requestParams) {
        ...
        setPageOption(createOp().keyWordLikeFields(BaseSysRoleEntityTableDef.BASE_SYS_ROLE_ENTITY.NAME, BaseSysRoleEntityTableDef.BASE_SYS_ROLE_ENTITY.LABEL).queryWrapper(QueryWrapper.create().and(qw -> {
            qw.eq(BaseSysRoleEntityTableDef.BASE_SYS_ROLE_ENTITY.USER_ID.getName(), tokenInfo.getLong("userId")).or(w -> {
        ...
        }, !isAdmin).and(BaseSysRoleEntityTableDef.BASE_SYS_ROLE_ENTITY.LABEL.ne("admin"))));
    }

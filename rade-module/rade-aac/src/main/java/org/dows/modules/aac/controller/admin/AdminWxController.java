...
import org.dows.modules.aac.params.CaptchaParam;
import org.dows.modules.aac.params.LoginParam;
import org.dows.modules.aac.params.RefreshTokenParam;
import org.dows.modules.aac.params.SmsCodeParam;
...
@Tag(name = "微信认证", description = "微信认证")
@RadeController
public class AdminWxController {
    ...
    @PostMapping("/phone")
    public Response phone(@RequestBody LoginParam param) {
    ...
    public Response uniPhone(@RequestBody LoginParam param) {
    ...
    @PostMapping("/smsCode")
    public Response smsCode(@RequestBody SmsCodeParam param) {
        String phone = param.getPhone();
    ...
    public Response password(@RequestBody LoginParam param) {
        String phone = param.getPhone();
